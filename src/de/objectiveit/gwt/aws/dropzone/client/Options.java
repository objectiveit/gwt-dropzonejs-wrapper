...
import de.objectiveit.gwt.aws.dropzone.client.event.DropzoneFallbackEvent;
...
public class Options extends JavaScriptObject implements DropzoneOptions {
	...
	@Override
	public final native void setClickable(Collection<Element> arrayOfClickableElements)/*-{
	...
	public final native void setFallback(DropzoneFallbackEvent fallbackHandler) /*-{
		this.fallback = function() {
			fallbackHandler.@de.objectiveit.gwt.aws.dropzone.client.event.DropzoneFallbackEvent::onFallback()();
		}
	}-*/;
